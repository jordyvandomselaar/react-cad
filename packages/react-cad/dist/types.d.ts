...
export type XPosition = number | "left" | "center" | "right" | {
    from: "left" | "center" | "right";
    offset?: number;
    unit?: Unit;
};
export type YPosition = number | "bottom" | "center" | "top" | {
    from: "bottom" | "center" | "top";
    offset?: number;
    unit?: Unit;
};
export type ZPosition = number | "back" | "center" | "front" | {
    from: "back" | "center" | "front";
    offset?: number;
    unit?: Unit;
};
